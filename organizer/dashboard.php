...
// Kick out anyone who is not logged in OR is not an organizer
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'create') {
    ...
    if (empty($title) || empty($event_type) || empty($start_datetime)) {
        ...
        // Insert the event, making sure to link it to this specific organizer!
...
// Notice the WHERE e.organizer_id = ? clause! This ensures they can't see other organizers' events.
$query = "
    SELECT e.*, 
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="adminNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <span class="nav-link text-light">Hello, <?php echo htmlspecialchars($_SESSION['first_name']); ?></span>
                </li>
                <li class="nav-item">
